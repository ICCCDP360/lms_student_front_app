...
function PractisePage({practiseData,heading}) {
  const navigate = useNavigate();
  return (
    <div className="practise-full-container">
      <p className="practise-header">Practice Instructions</p>
      ...
      <button
        ...
        onClick={() => navigate("/practise_text",{state:{data:practiseData,heading:heading}})}
      >
        Start Practice
      </button>
    </div>
